...
{   // This is the class for the warning sign. 
    // It will display an animated WARNING SIGN once the invasionmenter is above 80%
    ...
    class WarningSign
    {
        ...
        // Constructor
        public WarningSign(Texture2D spriteSheet, int xpos, int ypos, int fps)
        {
            ...
            m_animCell = new Rectangle(0, 0, spriteSheet.Width, spriteSheet.Height / 4);
            ...
            CollisionRect = new Rectangle(xpos, ypos, spriteSheet.Width, spriteSheet.Height / 4);
        }
